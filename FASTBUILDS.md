source: <https://github.com/bevyengine/bevy/blob/deb135c25c3a7eafdc432eaefe0957d6ffdcca62/.cargo/config_fast_builds.toml>

```toml
# Copy this file to `./cargo/config.toml` to speed up your builds
