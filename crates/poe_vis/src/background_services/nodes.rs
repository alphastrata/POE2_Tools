...
use crate::{
    ...
    events::{self, ManualNodeHighlightWithColourReq, NodeActivationReq, *},
...
pub(crate) fn process_manual_node_highlights(
    mut events: EventReader<ManualNodeHighlightWithColourReq>,
    mut colour_events: EventWriter<NodeColourReq>,
    mut commands: Commands,
    ...
    events
        .read()
        .for_each(|ManualNodeHighlightWithColourReq(node_id, colour_str)| {
